...
function metadataAPI(connection,logError){
    ...
    async function listMetadata(type){
        ...
        try {
            ...
            if(soapUtils.isSoapFailure(json)){
                ...
                let message = json['soapenv:Envelope']['soapenv:Body']['soapenv:Fault'].faultstring;
                throw new ErrorHandler(404,message,'Fault response from listMetadata()');  
